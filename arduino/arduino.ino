...
void velocityMeasure(int sensor)
{
    ...
    { // de fiets is voor de eerste keer gedetecteerd, de meting begint
        frontWheelTime = millis();
        firstSensor = sensor;
        hasFrontWheelPassedOne = true;
    }
    else if (sensor == firstSensor)
    { // het acchterwiel wordt voor de eerste keer gedetecteerd
    ...
    else
    {
        ...
        { //Berekening snelheid van het achterwiel.
        ...
        { //Berekening snelheid van het voorwiel.
